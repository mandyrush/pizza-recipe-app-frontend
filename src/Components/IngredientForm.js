...
const IngredientForm = ({
    ...
    return (
        <form>
            ...
            <input type="text" name="ingredientQuantity" id="ingredientQuantity" onChange={(event) => setIngredient({ ...ingredient, quantity: event.target.value })} />
            <label htmlFor="ingredientName">Ingredient</label>
            <input type="text" name="ingredientName" id="ingredientName" onChange={(event) => setIngredient({ ...ingredient, name: event.target.value })} />
